...
DIR = "E:\\3ro\\Semestre 2\\SRI\\Pre-entrega SRI\\Pre-entrega SRI\\Test Collections\\Test Collections\\20 Newsgroups\\20news-18828"
...
print("Write a query: ")
query=input()
print(start('newsgroup','boolean', query))
